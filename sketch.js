...
function preload() {
  ...
  awarenessImg = loadImage("ENDSCREEN.png");
  arrowImage = loadImage("vaccine.png");
...
function draw() {
  ...
  if (touches.length > 0 || mousePressedOver(readMe)) {
  ...
  if (gameState === PLAY) {
    ...
    if (World.frameCount % 30 == 0) {
     ...
     // What happs if vius touchs a person
